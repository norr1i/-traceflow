...
export default function NotificationPanel() {
  ...
  // Re-fetch when opening (to get freshest data)
  useEffect(() => {
  ...
  return (
    <div ref={panelRef} className="relative">
      ...
      {open && (
        <div
          className="absolute right-0 top-full z-50 mt-2 flex flex-col overflow-hidden rounded-xl border border-gray-200 dark:border-white/[0.08] bg-white dark:bg-[#0D1117] shadow-xl shadow-black/10 dark:shadow-black/50"
        ...
        >
          ...
          <div className="flex items-center justify-between gap-3 border-b border-gray-100 dark:border-white/[0.06] px-4 py-3">
            ...
            <div className="flex items-center gap-2">
              {loading && (
                <RefreshCw size={12} className="animate-spin text-gray-400 dark:text-[#525563]" />
              )}
              {unreadCount > 0 && (
                <button
                  onClick={markAllRead}
          ...
          {notifications.length > 0 && (
            <div className="border-t border-gray-100 dark:border-white/[0.06] px-4 py-2.5 flex items-center justify-between">
              ...
              <button
                ...
                className="text-[11px] text-gray-400 dark:text-[#525563] hover:text-gray-600 dark:hover:text-[#8B9BAA] transition-colors flex items-center gap-1"
              >
                <RefreshCw size={10} />
                Refresh
              </button>
